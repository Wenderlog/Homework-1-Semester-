...
int main() {
    ...
    int array2[] = { 33, 0, 3, 2, 1555, 46, 7, 218, 92, 190 };
    int lenghtArray2 = sizeof(array2) / sizeof(array2[0]);
    int numbersToSearch2[] = { 3, 33, 190 };
    printArray(array2, lenghtArray2);
    for (int i = 0; i < 3; i++) {
        printf("Test %d: Searching for %d - %s \n", i + 1, numbersToSearch2[i]);
        printf(testBinarySearch(array2, lenghtArray2, numbersToSearch2[i]) ? "Found\n" : "Not found\n");
    }

    int array3[] = { 33, 1, 3 };
    int lenghtArray3 = sizeof(array3) / sizeof(array3[0]);
    int numbersToSearch3[] = { 0, 0, 0 };
    printArray(array3, lenghtArray3);
    for (int i = 0; i < 3; i++) {
        printf("Test %d: Searching for %d - %s \n", i + 1, numbersToSearch3[i]);
        printf(testBinarySearch(array3, lenghtArray3, numbersToSearch3[i]) ? "Found\n" : "Not found\n");
    }
